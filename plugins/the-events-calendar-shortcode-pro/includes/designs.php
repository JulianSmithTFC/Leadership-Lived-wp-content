...
class ECSDesigns {
	...
	function add_design_attributes( $default_atts ) {
        ...
        $default_atts['filterbar'] = 'false';
        $default_atts['filterbar-category-title'] = __( 'Event Category', 'the-events-calendar-shortcode' );
        $default_atts['filterbar-venue-title'] = __( 'Venues', 'the-events-calendar-shortcode' );
        $default_atts['filterbar-country-title'] = __( 'Country', 'the-events-calendar-shortcode' );
        $default_atts['filterbar-state-title'] = __( 'State/Province', 'the-events-calendar-shortcode' );
        $default_atts['filterorder'] = 'category, venue, state, country';
	...
	function register_scripts() {
        wp_register_script( 'tecs-filter-bar-calendar', plugins_url( '/designs/assets/js/tecs-filter-bar.min.js', __FILE__ ), array( 'jquery' ), TECS_VERSION, true );
        wp_register_script( 'tecs-select2', plugins_url( '/designs/assets/js/select2.full.min.js', __FILE__ ), array( 'tecs-filter-bar-calendar' ), TECS_VERSION, true );
    }
}
