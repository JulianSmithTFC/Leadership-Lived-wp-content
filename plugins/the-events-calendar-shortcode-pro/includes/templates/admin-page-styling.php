...
<p><?php echo esc_html( __( 'Add a filter bar to the top of the calendar:', 'the-events-calendar-shortcode' ) ); ?></p>

<blockquote>[ecs-list-events design="calendar" filterbar="true"]</blockquote>
<blockquote>[ecs-list-events design="calendar" filterbar="true" filterorder="category, venue, state, country"]</blockquote>
<blockquote>[ecs-list-events design="calendar" filterbar="true" filter-category-title="Select Category"]</blockquote>
