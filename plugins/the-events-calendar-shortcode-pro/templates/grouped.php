...
if ( ! isset( $GLOBALS['ecn_grouped_last_date_' . $GLOBALS['ecs_columns_grouped_count']] ) or ( tribe_get_start_date( null, false, $ecs_date_format ) != $GLOBALS['ecn_grouped_last_date_' . $GLOBALS['ecs_columns_grouped_count']] ) )
	$display_start_date = true;
$GLOBALS['ecn_grouped_last_date_' . $GLOBALS['ecs_columns_grouped_count']] = tribe_get_start_date( null, false, $ecs_date_format );
?>
...
<div class="ecs-event">
    ...
    <?php if ( Events_Calendar_Shortcode::isValid( $atts['cost'] ) and tribe_get_cost( null, true ) ): ?>
        <span class="cost"><span class="separator"> - </span><?php echo tribe_get_cost( null, true ) ?></span>
    <?php endif; ?>
</div>
