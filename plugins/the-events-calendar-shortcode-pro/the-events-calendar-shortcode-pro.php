<?php
/*
Plugin Name: The Events Calendar Shortcode & Block PRO
Plugin URI: https://eventcalendarnewsletter.com/the-events-calendar-shortcode/
Description: Adds shortcode and block functionality with design options for The Events Calendar Plugin by Modern Tribe.
Version: 2.8.3
...
function ecsp_add_core() {
	...
	require_once( dirname( __FILE__ ) . '/block/init.php' );
...
require_once( dirname( __FILE__ ) . '/includes/filterbar.php' );
